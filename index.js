...
day >= 1 && day <= 10
  ? alert(`Переменная day попадает в первую декаду`)
  : day >= 11 && day <= 20
  ? alert(`Переменная day попадает в во вторую декаду`)
  : day >= 21 && day <= 31
  ? alert(`Переменная day попадает в третью декаду`)
  : alert(`Число введено неверно. В месяце максимум 31 день.`);
...
alert(
  `В числе ${num3} количество сотен: ${
    Math.floor(num3 / 100) % 10
  }, десятков: ${Math.floor(num3 / 10) % 10}, единиц: ${num3 % 10}`
);
